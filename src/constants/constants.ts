...
export const WorldsDataSection: WorldsData[] = [
  {
    id: "1",
    worldName: "Fundamentos",
    waterColor: "#2d4cc9",
    landColor: "#7cc133",
    rotationDurationMs: 18000,
    rotationDirection: "forward",
    rotationOffsetDeg: 60,
    continentSeed: 101,
    continentCount: 4,
  },
  {
    id: "2",
    worldName: "Estruturas de repetição",
    waterColor: "#1f9cd6",
    landColor: "#8de5ff",
  ...
  {
    id: "3",
    worldName: "Condições compostas",
    waterColor: "#5d3fd3",
    landColor: "#f58bf9",
    rotationDurationMs: 20000,
    rotationDirection: "forward",
    rotationOffsetDeg: 36,
    continentSeed: 307,
    continentCount: 5,
  },
  {
    id: "4",
    worldName: "Vetores (arrays)",
    waterColor: "#0d9488",
    landColor: "#9ff3d5",
    rotationDurationMs: 19000,
    rotationDirection: "reverse",
  ...
  },
  {
    ...
    waterColor: "#2563eb",
    landColor: "#f472b6",
    rotationDurationMs: 21000,
    rotationDirection: "reverse",
    rotationOffsetDeg: 28,
    continentSeed: 613,
    continentCount: 6,
  },
  {
    id: "7",
    worldName: "Algoritmos intermediários",
    waterColor: "#7c3aed",
    landColor: "#fde68a",
    rotationDurationMs: 19500,
    rotationDirection: "forward",
    rotationOffsetDeg: -32,
    continentSeed: 719,
    continentCount: 5,
  },
  {
    id: "8",
    worldName: "Estruturas avançadas",
    waterColor: "#14b8a6",
    landColor: "#bef264",
  ...
  {
    id: "9",
    worldName: "Algoritmos clássicos",
    waterColor: "#0ea5e9",
    landColor: "#fb7185",
    rotationDurationMs: 20500,
    rotationDirection: "forward",
    rotationOffsetDeg: 42,
    continentSeed: 929,
    continentCount: 5,
  },
  {
    id: "10",
    worldName: "Desafios avançados",
    waterColor: "#1e3a8a",
    landColor: "#facc15",
