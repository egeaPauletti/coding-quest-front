    ...
    <section id="forPlayers" className="w-screen min-h-screen h-max flex flex-col justify-center items-center gap-10 my-50 py-25">
      ...
      <div className="w-screen h-max flex flex-col gap-10 justify-center items-center">
        <div className="w-[60%] h-max flex gap-10">
          <div className="w-full h-60 border-2 border-primary/70 border-dashed flex flex-col flex-1 justify-start gap-5 p-10">
            <h3 className="w-full flex justify-center text-primary text-xl font-semibold">Quem está querendo começar a Estudar!</h3>
            <p className="w-full text-justify text-white text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate illo optio repellendus, quaerat nulla at nam, fugit necessitatibus tempore iusto harum cumque qui placeat molestias distinctio.</p>
          </div>
          <div className="w-full h-60 border-2 border-primary/70 border-dashed flex flex-col flex-1/12 justify-start gap-5 p-10">
